    ...
    <div className='home-content bg-accent'>
      <section className='home-intro p-6'>
        ...
        <div className="flex items-center gap-4">
          <img src="avatar-mouse.png" className='w-16 h-16' alt="Your avatar image"/>
          <div className="flex flex-col">
            <p className='text-2xl font-semibold text-pink-global text-accent-foreground'>Hey, {user.first_name}</p>
